#!/usr/bin/python3
""" objects that handle all default RestFul API action for cities """
from models.city import City
from models.state import State
from models import storage
from api.v1.viws import app_views
...
def get_cities(state_id):
    """ retrieve the list fo all cities, objects or specific state"""
    list_cities = []
...
def get_city(city_id):
    """ retreives specific city based on id """
