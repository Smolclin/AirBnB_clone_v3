#!/usr/bin/python3
""" object that  handles all the default ResFil API actions for Amenities """
from models.amenities import Amenities
from models import storage
from flask import abort, jsonify, make_response, request
from flagger.utils import swag_from
...
def get_amenities():
    """ gets/retreives a list of all amenities """
...
def post_amenity():
    ...
    if 'name' not in request.get_json():
        about(400, description="Missing name")
